...
NUM_SEGMENTS = 20   # The resolution of the simulation along the ray path
...
GRADIENT_WIDTH_MULTIPLIER = 1  # Repeats each sampled color horizontally for smoother gradients
